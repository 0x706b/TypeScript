...
namespace ts {
    ...
    export function transformTsPlus(checker: TypeChecker, options: CompilerOptions, host: CompilerHost) {
        return function (context: TransformationContext) {
            ...
            // function visitExportDeclaration(source: SourceFile, traceInScope: Identifier | undefined, node: ExportDeclaration, context: TransformationContext): VisitResult<Node> {
            ...
            //                 node.exportClause,
            //                 node.exportClause.elements.map((specifier) => {
            //                     if (specifier.propertyName) {
            //                         return context.factory.updateExportSpecifier(
            //                             specifier,
            //                             node.isTypeOnly,
            //                             visitIdentifier(source, traceInScope, specifier.propertyName, context),
            //                             specifier.name
            //                         );
            //                     }
            //                     return specifier;
            ...
            function visitIdentifier(source: SourceFile, traceInScope: Identifier | undefined, node: Identifier, context: TransformationContext): Identifier {
                if (node.escapedText.toString() === "conflict") {
                    debugger;
                }
