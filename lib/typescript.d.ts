...
declare namespace ts {
    ...
    export type VariableDeclarationWithFunction = VariableDeclaration & {
        name: Identifier;
    ...
    export type TsPlusSymbol = TsPlusFluentSymbol | TsPlusStaticSymbol | TsPlusGetterSymbol | TsPlusGetterVariableSymbol;
