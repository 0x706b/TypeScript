...
/**
 * @tsplus macro pipeableConstrained
 */
declare function PipeableConstrained<F extends (...contstraints: any) => (self: any, ...rest: any) => any>(f: F): (...contstraints: Parameters<F>) => (...rest: PipeableShift<Parameters<ReturnType<F>>>) => (self: PipeableFirst<Parameters<ReturnType<F>>>) => ReturnType<ReturnType<F>>