...
declare namespace ts {
    ...
    export type SignatureWithParameters = Omit<Signature, "parameters"> & {
    ...
    export interface EtsFluentVariableSymbol extends TransientSymbol {
        ...
        etsDeclaration: VariableDeclaration & {
            name: Identifier;
        };
    ...
    export type EtsSymbol = EtsFluentSymbol | EtsStaticSymbol | EtsGetterSymbol | EtsFluentVariableSymbol | EtsGetterVariableSymbol;
    ...
    export interface TypeChecker {
        ...
        getFluentExtension(target: Type, name: string): {
            patched: Symbol;
        ...
        getStaticExtension(target: Type, name: string): {
            patched: Symbol;
            definition: SourceFile;
            exportName: string;
        } | undefined;
