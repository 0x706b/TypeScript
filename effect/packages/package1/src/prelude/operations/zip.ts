 ...
 */
export function zipRight<R, E, A, R2, E2, A2>(self: Effect<R, E, A>, that: LazyArgument<Effect<R2, E2, A2>>, __tsplusTrace?: string): Effect<R & R2, E | E2, A2> {
    return T.zipRight_(self, that());
}